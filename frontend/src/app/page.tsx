...
export default function Home() {
  ...
  if (!configured) {
    return (
      <div className={panel}>
        <h2 className="text-lg font-semibold text-ink">Contracts not configured</h2>
        <p className={sub}>
        ...
        >
          <div className="mt-11 grid w-[min(560px,100%)] gap-4">
            <div className="rounded-lg border border-ed-line border-l-4 border-l-ed-gold bg-white/[0.08] px-4 py-3 text-sm text-ed-cream/90">
              <b className="text-ed-gold">Testnet · Zero-knowledge.</b> Payments arrive as shielded
              notes; withdrawals are proven in your browser and reveal nothing
              linking them to the deposit. Note details are encrypted to you.
            </div>
              ...
              <>
                ...
                <div className={`${panel} bg-ed-cream border-ink/10`}>
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="break-all font-mono text-sm text-muted">{payLink || "…"}</div>
                    <button
                ...
                <div className={`${panel} bg-ed-cream border-ink/10`}>
                  ...
                  <div className={bignum}>
                    {balance} <small className="text-base font-normal text-muted">USDC in wallet</small>
                  </div>
                  <p className={sub}>
